...
1. Download the latest `.msix` file from the repo, then navigate to the folder you downloaded it to in File Explorer
2. Right-click the package and select _Properties_
3. **Properties**: Switch to the _Digital Signatures_ tab, then select `Finamp` under _Signature list_, then click _Details_
